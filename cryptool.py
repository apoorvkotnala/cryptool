...
def cli_parser():
    ...
    parser.add_argument("-k2tdes", action='store_true', default=False, help="Use 128-bit TDES for Encryption/Decryption.")
    parser.add_argument("-k3tdes", action='store_true', default=False, help="Use 192-bit TDES for Encryption/Decryption.")
    ...
    return args.caesar, args.affine, args.vigenere, args.des, args.k2tdes, args.k3tdes, args.f, args.encrypt, args.decrypt
...
if __name__ == '__main__':
    ...
    caesar, affine, vigenere, des, k2tdes, k3tdes, f, encrypt, decrypt = cli_parser()
    ...
    if caesar:
        ...
        if not f:
            ...
            if encrypt:
                print("\n" + bcolors.OKBLUE + "ENCRYPTED TEXT :" + bcolors.ENDC + "\n")
                print(desobj.encrypt(key, text) + "\n")
            elif decrypt:
                print("\n" + bcolors.OKBLUE + "DECRYPTED TEXT :" + bcolors.ENDC + "\n")
                print(desobj.decrypt(key, text) + "\n")
            else:
                print("Provide Encrypt/Decrypt Tag.")
                sys.exit()
        elif f:
            ...
            try:
                with open(f) as datafile:
                    ...
                    if encrypt:
                        ...
                        processed_text = ""
                        for text in textlist:
                            processed_text = processed_text + desobj.encrypt(key, text)
                        print(processed_text)
                        print()
                    elif decrypt:
                        print("\n" + bcolors.OKBLUE + "DECRYPTED TEXT :" + bcolors.ENDC + "\n")
                        processed_text = ""
                        for text in textlist:
                            processed_text = processed_text + desobj.decrypt(key, text)
                        print(processed_text)
                        print()
                    else:
                        print("Error: Provide Encrypt/Decrypt Tag.")
     ...
     print(bcolors.OKGREEN + "	  -k2tdes" + bcolors.ENDC)
     print(bcolors.OKWHITE + "	       Encrypt/Decrypt using 2 Key TDES Cypher." + bcolors.ENDC)
     print(bcolors.OKGREEN + "	  -k3tdes" + bcolors.ENDC)
     print(bcolors.OKWHITE + "	       Encrypt/Decrypt using 3 Key TDES Cypher." + bcolors.ENDC)
